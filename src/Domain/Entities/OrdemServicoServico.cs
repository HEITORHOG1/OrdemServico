...
/// <summary>
/// Entidade filha que representa um item de serviço a ser executado na OS.
/// </summary>
public sealed class OrdemServicoServico
{
    ...
    private OrdemServicoServico() { }

    internal static OrdemServicoServico Criar(Guid ordemServicoId, string descricao, int quantidade, decimal valorUnitario, int ordem)
    {
        ...
        if (string.IsNullOrWhiteSpace(descricao))
            throw new ArgumentException("A descrição do serviço é obrigatória.", nameof(descricao));
